          ...
          <section className="about-section" id="about">
            <div className="container">
              <div className="about-content fade-in">
                <h2>Discover TableTurn</h2>
                <p>TableTurn connects you to top Greek restaurants and venues, offering seamless AI-powered reservations for any occasion — romantic dinners, celebrations, or group events. Start your journey to unforgettable dining today.</p>
