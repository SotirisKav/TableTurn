...
import ChatWithTablio from './components/ChatWithTablio';
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/browse-festivals" element={<PageTransition><div style={{padding:'4rem',textAlign:'center'}}><h1>Browse Festivals (Coming Soon)</h1><p>Discover Greek festivals and events soon on TableTurn!</p></div></PageTransition>} />
        <Route path="/reservation/:restaurantId" element={<PageTransition><Reservation /></PageTransition>} />
        <Route path="/chat/:restaurantId?" element={<PageTransition><ChatWithTablio /></PageTransition>} />
