...
-- Seafood
INSERT INTO menu_item (venue_id, name, description, price, category, is_vegetarian, is_vegan, is_gluten_free)
VALUES
...
-- Drinks, more categories, and more items can be added similarly.